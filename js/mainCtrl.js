angular.module('itunes').controller('mainCtrl', function($scope, itunesService){
  ...
  $scope.getSongData = function(artist) {
    itunesService.getItunes(artist)
  ...
  //is sort the data you got back to be an object in the following format.
    /*
      ...
      Type: "song"
  */
  //the iTunes API is going to give you a lot more details than ng-grid wants. Create a new array and then loop through the iTunes data pushing into your new array objects that look like the above data. Do this in the service.
